...
//
$_POST['no_des']=str_replace(" ","",$_POST['no_des']);
$_POST['position_of_wave']=str_replace(" ","",$_POST['position_of_wave']);
$_POST['wave_length']=str_replace(" ","",$_POST['wave_length']);
...
<title>Alignment with diode array detector</title>
<link rel="stylesheet" type="text/css" href="style.css">
</head>

<body>
        <div id="right_content">
        	<table border="0" width="580" cellpadding="5" cellspacing="1" style="margin-left:10px; ">
...
if  ( copy($_FILES['Samples']['tmp_name'], "./".$_FILES['Samples']['name'])) {
	...
	$command = 
		...
		"s_flag="				.$s_flag				."\n".
		"e_flag="				.$e_flag				."\n".
		"location_wave_table="	.$_POST['position_of_wave']		."\n".
		"rows_of_description="	.$_POST['no_des']		."\n".
		"wave_length="			.$_POST['wave_length']		."\n".
		"target=\""				.$_POST['target']		."\"\n";

	$fp=fopen("temp.r","w");
	fputs($fp,$command);
	fclose($fp);
	exec("cat temp.r ../autospike_dad.r > autospike_dad.r");
	...
	exec("/usr/bin/R --no-save < autospike_dad.r");
